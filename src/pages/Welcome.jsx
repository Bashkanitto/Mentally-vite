  ...
  return (
    <>
      <div
        ...
        className="absolute top-0 left-0 bg-slate-950 opacity-45"
      ></div>

      <form
        onSubmit={handleEmail}
        style={{ display: isModalOpen ? "flex" : "none" }}
        className="modal absolute flex flex-col z-20 justify-center items-center p-4 top-1/3 left-[40%] rounded-xl bg-white w-60 h-60"
      >
        <h2>Авторизация</h2>
        <input
          type="email"
      ...
      <div className="main">
        ...
        <h1>Я - Mentally</h1>
        <h2>Я здесь чтобы выслушать вас, как к Вам обращаться?</h2>
